...
from mushroom_rl.environments.isaacsim_envs.isaac_a1_description import IsaacA1Description
...
if __name__ == '__main__':
    ...
    experiment(alg=PPO, n_epochs=40, n_steps=200000, n_steps_per_fit=10000,
