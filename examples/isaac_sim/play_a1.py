...
def experiment(alg, num_envs, n_epochs, n_steps, n_steps_per_fit, n_episodes_test,
    ...
    mdp = IsaacA1Description(num_envs, 200, False)
    ...
    agent = agent.load("/home/bjarne/GitWorkspace/BachelorThesis/mushroom-rl/stored_agents/a1_ppo/1734141866.2268927.zip")
...
if __name__ == '__main__':
    ...
    experiment(alg=PPO, num_envs=num_envs, n_epochs=80, n_steps=4096*24*20, n_steps_per_fit=4096*24,
                   n_episodes_test=num_envs*10, alg_params=ppo_params, policy_params=policy_params)
