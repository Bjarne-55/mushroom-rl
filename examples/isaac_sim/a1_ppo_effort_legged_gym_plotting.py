...
def experiment(alg, num_envs, n_epochs, n_steps, n_steps_per_fit, n_episodes_test,
    ...
    mdp = IsaacA1Description(num_envs, 1000, False)
    mdp.seed(seed)
    ...
    #agent = agent.load("/home/bjarne/GitWorkspace/BachelorThesis/mushroom-rl/stored_agents/a1_ppo/1734484712.6502075.zip")
