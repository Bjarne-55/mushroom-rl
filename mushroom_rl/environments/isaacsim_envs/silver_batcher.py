...
class Silver_Batcher(HoneyBatcher):
    ...
    def __init__(self, num_envs, horizon, headless):
        ...
        observation_spec = [
            ...
            ("RL_hip_joint_pos", "/rear/rl_j0", ObservationType.JOINT_POS),#RL
            ("RL_hip_joint_vel", "/rear/rl_j0", ObservationType.JOINT_VEL),
            ...
            ("RR_hip_joint_pos", "/rear/rr_j0", ObservationType.JOINT_POS),#RR
            ("RR_hip_joint_vel", "/rear/rr_j0", ObservationType.JOINT_VEL),
        ...
        collision_groups = [
            ...
            ("RR_foot", ["/rr_foot"]),
            ("body", ["/body", "/rear"]),
            ("lower_body", ["/fl_l1", "/fr_l1", "/rl_l1", "/rr_l1", "/fl_l2", "/fr_l2", "/rl_l2", "/rr_l2"])
        ]
